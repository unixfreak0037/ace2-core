...
@pytest.mark.parametrize('amt,observable,expected_result', [
    ...
    # limited analysis
    (TempAnalysisModuleType(), RootAnalysis().add_observable(Observable('test', 'test', limited_analysis=['test'])), True),
    # limited analysis (not in list)
    (TempAnalysisModuleType(), RootAnalysis().add_observable(Observable('test', 'test', limited_analysis=['other'])), False),
    # excluded analysis
    (TempAnalysisModuleType(), RootAnalysis().add_observable(Observable('test', 'test', excluded_analysis=['test'])), False),
    # excluded analysis (not in list)
    (TempAnalysisModuleType(), RootAnalysis().add_observable(Observable('test', 'test', excluded_analysis=['other'])), True),
